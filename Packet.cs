...
public class Packet : IDisposable
{
    ...
    /// <summary>Adds a file by converting to strings from the packet.</summary>
    /// <param name="_moveReadPos">Whether or not to move the buffer's read position.</param>
    public void Write(string path, string fname)
    {
        Write(fname);
    ...
    public List<string> ReadList(bool _moveReadPos = true)
    {
        ...
        {
            _value.Add(ReadString());
        }
        return _value;
    }
    /// <summary>Reads a file and convert to strings from the packet.</summary>
    /// <param name="_moveReadPos">Whether or not to move the buffer's read position.</param>
    public string ReadFile(bool _moveReadPos = true)
    {
